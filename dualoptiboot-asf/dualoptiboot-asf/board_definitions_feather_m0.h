 ...
 */
#define STRING_PRODUCT "NSB M0 Bootloader"
#define USB_VID_HIGH 0x23
#define USB_VID_LOW 0x9A
#define USB_PID_HIGH 0x00
#define USB_PID_LOW 0x1B /* Adafruit Feather M0 Express PID so we can differentiate between older ones using Feather M0 PID */
