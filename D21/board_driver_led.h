...
{
    PORT->Group[BOARD_LED_PORT].OUTTGL.reg = ( 1 << BOARD_LED_PIN );
}
#else
inline void LED_init( void )
{}
...
{
    PORT->Group[BOARD_LEDRX_PORT].DIRSET.reg = ( 1 << BOARD_LEDRX_PIN );
}
...
{
    PORT->Group[BOARD_LEDRX_PORT].OUTTGL.reg = ( 1 << BOARD_LEDRX_PIN );
}
#else
inline void LEDRX_init( void )
{}
...
{
    PORT->Group[BOARD_LEDTX_PORT].DIRSET.reg = ( 1 << BOARD_LEDTX_PIN );
}
...
{
    PORT->Group[BOARD_LEDTX_PORT].OUTTGL.reg = ( 1 << BOARD_LEDTX_PIN );
}
#else
inline void LEDTX_init( void )
{}
